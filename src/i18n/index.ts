...
const en = {
  ...
  'addExpense.locationPlaceholder': 'Coffee shop, office, supermarket...',
  'addExpense.merchantLabel': 'Merchant',
  'addExpense.merchantPlaceholder': 'Store or business name',
  'addExpense.suggestionsTitle': 'Suggestions from this location',
  'addExpense.suggestionsEmpty': 'No repeated items found for this location yet.',
...
const es: Record<TranslationKeyInternal, string> = {
  ...
  'addExpense.locationPlaceholder': 'Cafetería, oficina, supermercado...',
  'addExpense.merchantLabel': 'Comercio',
  'addExpense.merchantPlaceholder': 'Nombre del negocio',
  'addExpense.suggestionsTitle': 'Sugerencias de esta ubicación',
  'addExpense.suggestionsEmpty':
    'Aún no se encontraron artículos repetidos para esta ubicación.',
