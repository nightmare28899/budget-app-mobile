...
const en = {
    ...
    'legal.registerNotice': 'By creating your account, you accept the Terms and Conditions.',
    'legal.googleNotice': 'By continuing with Google, you accept the Terms and Conditions.',
    ...
    'categoryBudgets.periodHint': 'All category limits are measured inside {range}.',
    ...
    'categoryBudgets.loadError': 'Could not load category budgets. Pull to refresh or retry.',
    ...
    'income.emptyDescription': 'Add your first income so the app can show your real cashflow.',
    'income.loadErrorDescription': 'Could not load income. Pull to refresh or retry.',
    'income.addFirst': 'Add income',
    'income.addTitle': 'Add income',
    'income.editTitle': 'Edit income',
    'income.subtitle': 'Track money coming in so the app can explain your real balance.',
    ...
    'income.tip': 'Add every paycheck, transfer, or side income to get a better net cashflow picture.',
    ...
    'analytics.savingsRate': 'You are retaining about {percent}% of your income in this selected period.',
    'analytics.cashflowEmptyHint': 'Add income records to compare what came in versus what went out.',
    'analytics.subscriptionSavingsTitle': 'Savings Opportunity',
    'analytics.saveByCancelling': 'Cancel active subscriptions and save {amount} in {months} months.',
    'analytics.activeSubscriptionsMeta.one': '{count} active subscription · {amount}/month',
    'analytics.activeSubscriptionsMeta.other': '{count} active subscriptions · {amount}/month',
    'analytics.topSubscriptions': 'Biggest subscription impact',
    'analytics.saveInMonths': 'Save {amount} in {months} months',
    'analytics.noSubscriptionsToOptimize': 'No active subscriptions to optimize right now.',
    ...
    'settings.selectBudgetPeriod': 'Choose how your spending limit should be calculated.',
...
const es: Record<TranslationKeyInternal, string> = {
    ...
    'legal.registerNotice': 'Al crear tu cuenta, aceptas los Términos y Condiciones.',
    'legal.googleNotice': 'Al continuar con Google, aceptas los Términos y Condiciones.',
    ...
    'categoryBudgets.periodHint': 'Todos los límites por categoría se miden dentro de {range}.',
    ...
    'categoryBudgets.failedUpdate': 'No se pudo actualizar el límite de esta categoría.',
    ...
    'income.emptyDescription': 'Agrega tu primer ingreso para que la app te muestre tu flujo real.',
    'income.loadErrorDescription': 'No se pudieron cargar los ingresos. Desliza para refrescar o reintentar.',
    'income.addFirst': 'Agregar ingreso',
    'income.addTitle': 'Agregar ingreso',
    'income.editTitle': 'Editar ingreso',
    'income.subtitle': 'Registra el dinero que entra para entender mejor tu balance real.',
    'income.amountPlaceholder': '0.00',
    ...
    'income.tip': 'Agrega cada nómina, transferencia o ingreso extra para ver mejor tu flujo neto.',
    ...
    'analytics.noCategoryImpact': 'Todavía no hay una categoría dominante este mes.',
    'analytics.cashflowTitle': 'Resumen de flujo',
    'analytics.savingsRate': 'Estás reteniendo alrededor del {percent}% de tus ingresos en este período seleccionado.',
    'analytics.cashflowEmptyHint': 'Agrega ingresos para comparar lo que entró contra lo que salió.',
    'analytics.subscriptionSavingsTitle': 'Oportunidad de ahorro',
    'analytics.saveByCancelling': 'Si cancelas tus suscripciones activas, podrías ahorrar {amount} en {months} meses.',
    'analytics.activeSubscriptionsMeta.one': '{count} suscripción activa · {amount}/mes',
    'analytics.activeSubscriptionsMeta.other': '{count} suscripciones activas · {amount}/mes',
    'analytics.topSubscriptions': 'Suscripciones con mayor impacto',
    'analytics.saveInMonths': 'Ahorra {amount} en {months} meses',
    'analytics.noSubscriptionsToOptimize': 'No hay suscripciones activas para optimizar en este momento.',
