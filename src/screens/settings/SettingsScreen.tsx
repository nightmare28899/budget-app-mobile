...
export function SettingsScreen({ navigation }: RootScreenProps<'Settings'>) {
  ...
  const { scrollRef, createScrollOnFocusHandler } =
    useScrollToFocusedInput(116);
  const {
    horizontalPadding,
    contentMaxWidth,
    isSmallPhone,
  ...
  const { isAuthenticated, isGuest, hasPremium } = useAppAccess();
  const {
    t,
    language,
    user,
  ...
  const quickThemeModes: ThemeMode[] = [
    'system',
    ...themeOptions.map(item => item.id),
  ];
  const accessLabel = isGuest
    ? t('guest.statusGuest')
    : t('guest.statusAccount');
  const planStatusLabel = hasPremium
        ...
        <View style={styles.avatarContainer}>
          ...
          <View style={styles.avatarActions}>
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <Icon name="image-outline" size={16} color={colors.textPrimary} />
              <Text
                style={[
            ...
            {!!avatarUri && (
              <TouchableOpacity onPress={onRemovePhoto} activeOpacity={0.8}>
                <Text
                  style={[
      ...
      >
            ...
            <View style={styles.themePreviewRow}>
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      themeDefinitions[resolvedThemeId].colors.background,
                    borderColor:
                      themeDefinitions[resolvedThemeId].colors.border,
                  },
                ]}
              />
              <View
                style={[
                  styles.themePreviewDot,
                  {
                    ...
                    borderColor:
                      themeDefinitions[resolvedThemeId].colors
                        .primaryActionHover,
                  },
                ]}
              />
        ...
        <View style={styles.themeChipsRow}>
          {quickThemeModes.map(mode => {
            ...
            const previewMode = mode === 'system' ? resolvedThemeId : mode;
              ...
              >
                ...
                <Text
                  style={[
                    ...
                    isActive ? { color: themeColors.textPrimary } : null,
                    { fontSize: scaleFont(typography.fontSize.xs) },
                  ]}
                >
        ...
        {isAuthenticated ? (
          <View style={styles.actionRow}>
            ...
            <View style={styles.actionInfo}>
              ...
              >
                {t('settings.autoWeeklyReportDesc')}
              </Text>
            </View>
            <Switch
              value={weeklyReportEnabled}
              onValueChange={onToggleWeeklyAutomaticReport}
              disabled={isSavingReportPreferences}
              trackColor={{
                false: colors.border,
        ...
        {isAuthenticated ? (
          <View style={styles.actionRow}>
            ...
            <View style={styles.actionInfo}>
              ...
              >
                {t('settings.autoMonthlyReportDesc')}
              </Text>
            </View>
            <Switch
              value={monthlyReportEnabled}
              onValueChange={onToggleMonthlyAutomaticReport}
              disabled={isSavingReportPreferences}
              trackColor={{
                false: colors.border,
              ...
              thumbColor={
                monthlyReportEnabled ? colors.secondary : colors.surfaceElevated
              }
              ios_backgroundColor={colors.border}
              style={styles.actionSwitch}
            />
